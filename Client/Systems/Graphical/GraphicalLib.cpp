...
bool GraphicalLib::addElementSprite(const uint &id, const std::string &sprite_name)
{
    ...
    {"Enemy1",  {{0, 0,  230, 36},     {0, 0,  33, 36},   {33, 0}}},
    {"Enemy2",  {{33, 34, 99, 67},     {33, 34,  33, 33},   {33, 0}}},
    {"Enemy3",  {{50, 0,  109, 58},     {50, 0, 109, 58},   {0, 0}}},
    {"Enemy4",  {{15, 11,  84, 41},     {15, 11,  84, 41},   {0, 0}}},
    {"Enemy5",  {{272, 9,  341, 24},     {272, 9,  299, 24},   {17, 0}}},
    {"Enemy6",  {{0, 67,  132, 100},     {0, 67,  33, 33},   {33, 0}}},
    {"Enemy7",  {{18, 14,  84, 51},     {18, 14,  84, 51},   {0, 0}}},
    {"PlayerShot",  {{103, 169,  265, 186},  {103, 169,  184, 186},   {81, 0}}}
    };
